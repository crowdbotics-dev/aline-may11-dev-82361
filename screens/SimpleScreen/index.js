...
const SimpleScreen = () => <View style={page.container}>
    ...
    <Text style={[page.text, deepStyle, page.ldLMSOTA]}>Merging local and single object from external file and inline.</Text>
    <Text style={[deepStyle, page.MDqIshca]}>Deep external and inline.</Text>
     <Text style={[custom.background, page.XhZYALfA]}>Normal external from stylesheet and inline.</Text>
